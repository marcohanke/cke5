...
/**
 * Liefert Metadaten zu einer Mediapool-Datei für CKE5-Plugins.
 *
 * Aufruf: ?rex-api-call=cke5_media_meta&file=foo.jpg&clang=2
 *
 * Antwort:
 * {
 *   "file": "foo.jpg",
 ...
 * }
 *
 * Wird von redaxo-media-alt.js verwendet, um beim Bild-Einfügen/-Austausch
 * den ALT-Text aus dem Mediapool zu übernehmen. Bevorzugt das MediaPlace-
 * eigene ALT-Feld (falls aktiv/konfiguriert), sonst ein klassisches
 * Metainfo-Feld (`med_alt` o.ä.), das auch ein metainfo_lang_fields-Typ
 * sein darf.
 */
class rex_api_cke5_media_meta extends rex_api_function
{
    /** @var bool */
     ...
     */
    public static function buildMeta(string $file, ?int $clangId): array
    {
        $file = basename($file);
        $result = [
            'file' => $file,
